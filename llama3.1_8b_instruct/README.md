...
This repository allows you to chat with the *[Llama3.1-8B-instruct](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct)* model in a self-contained environment.
